...
module.exports = async () => {
  try {
    ...
    let seedData = await axios.post(`${process.env.MEDUSA_BACKEND_URL || 'http://localhost:9000'}/hooks/seed`, {}, {});
    ...
    await strapi.services['fulfillment-provider'].bootstrap(fulfillmentProviders);
    ...
    if (e.code === 'ECONNREFUSED') {
      strapi.log.fatal('Unable to connect to Medusa server. Please make sure Medusa server is up and running');
      process.exit(1);
    }
  }
