export default async (req, res) => {
    try {
        ...
        const allShippingProfileCount = await getCount(manager, shippingProfileRepository);
        const allShippingOptionCount = await getCount(manager, shippingOptionRepository);
        ...
        const allShippingOptions = await shippingOptionService.list({}, shippingOptionsConfig);
        const allShippingProfiles = await shippingProfileService.list({}, shippingProfileConfig);
...
function getCount(manager, repository) {
    const customRepository = manager.getCustomRepository(
        repository
    )
